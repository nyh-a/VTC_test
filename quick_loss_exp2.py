...
STUDENT_MODEL_NAME = "/home/u2120230655/codes/VTC/all-mpnet-base-v2"
STUDENT_MODEL_NAME = "/home/u2120230655/codes/VTC/bert-base-uncased"
GUIDE_MODEL_NAME = "/home/u2120230655/codes/VTC/Qwen3-Embedding-0.6B"
BATCH_SIZE = 128
# 设置一个相对充足的 Epoch 数量，让模型有机会过拟合
# 我们将依赖验证集来找到最佳点
NUM_EPOCHS = 10
EXPERIMENT_NAME = 'GISTEmbed_Comparison' # 给这次实验起个名字，用于保存模型
...
if __name__ == '__main__':
    ...
    dataloader = DataLoader_Base(data_path=DATA_PATH, taxonomy_name=TAXONOMY_NAME, processor_path="/home/u2120230655/codes/VTC/blip-itm-large-coco")
